export default function api() {
  ...
  return {
    ...
    "wallet-tank": `${devApiDomain}api/wallet-tank-detail/`,
    ...
    "forget-password-check": `${devApiDomain}api/user/forget-password-check-code/`,
    "forget-password-set": `${devApiDomain}api/user/forget-password-set-pass/`,
