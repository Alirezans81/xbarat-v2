export default function api() {
  ...
  return {
    ...
    refresh: `${apiDomain}api/user/refresh/`,
    ...
    "other-exchanges": `${apiDomain}api/exchange/`,
    ...
    "forget-password-check": `${apiDomain}api/user/forget-password-check-code/`,
    "forget-password-set": `${apiDomain}api/user/forget-password-set-pass/`,
