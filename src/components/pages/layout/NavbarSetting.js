    ...
    setAllLinks([
      {
        ...
        imgs: {
          ...
          blue: require("../../../Images/pages/layout/Navbar/home-blue.png"),
        },
        shown: true,
      },
      {
        ...
        imgs: {
          ...
          blue: require("../../../Images/pages/layout/Navbar/wallet-blue.png"),
        },
        shown: true,
      },
      {
        ...
        imgs: {
          ...
          blue: require("../../../Images/pages/layout/Navbar/reports-blue.png"),
        },
        shown: true,
      },
      {
        ...
        imgs: {
          ...
          blue: require("../../../Images/pages/layout/Navbar/home-gray.png"),
        },
        shown: false,
      },
      {
