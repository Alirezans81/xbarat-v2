  ...
  if (lastTickets && lastTickets.length) {
              ...
              >
                <div className="w-full">
                  ...
                  {ticket.status === "newMessage" && (
                    <span
                      className={`text-blue font-${font}-regular text-sm mx-1.5`}
                    >
                  ...
                  {ticket.status === "ended" && (
                    <span
                      className={`text-red font-${font}-regular text-sm mx-1.5`}
                    >
                      {lang["ticket-ended"] + "."}
                    </span>
                  )}
                  {ticket.status === "sendedMessage" && (
                    <span
                      className={`text-gray font-${font}-regular text-sm mx-1.5`}
                    >
                ...
                <span
                  className={`font-${font}-regular mx-1.5 text-gray text-sm`}
                >
    ...
    return (
      <div className="w-full h-full flex justify-center items-center">
        <span
          className={`text-2xl md:text-3xl text-${oppositeTheme} font-${font}-thin`}
        >
          {lang["no-data"]}
        </span>
      </div>
